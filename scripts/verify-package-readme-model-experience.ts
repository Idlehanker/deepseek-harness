...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/tui': { kind: 'none', reason: 'The interactive runner submits each entered line as an ordinary user message; prompts and tools belong to the composed base and tui bundles.' },
